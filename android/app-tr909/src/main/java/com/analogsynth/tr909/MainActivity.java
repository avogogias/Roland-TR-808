...
/**
 * Roland TR-909 Drum Machine — standalone Android app.
 *
 * Features verified:
 *   - 16-step sequencer with accent
 *   - Punchy click-transient bass drum synthesis
 *   - Resonant hi-hat voices (closed / open)
 *   - Snare, Tom (low/mid/high), Rim Shot voices
 *   - BPM control and pattern playback
 */
public class MainActivity extends AppCompatActivity {
    ...
    static final String SYNTH_URL =
            ASSET_BASE_URL + "plugins/TR909/TR909.html";
