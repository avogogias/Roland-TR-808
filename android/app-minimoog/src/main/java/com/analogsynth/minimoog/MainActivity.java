...
/**
 * Moog Minimoog Model D — standalone Android app.
 *
 * Features verified:
 *   - 3 voltage-controlled oscillators (VCO 1, 2, 3) with waveform selection
 *   - Moog ladder filter (24 dB/oct LPF) via AudioWorklet
 *   - Filter and amplifier envelope generators (ADSR)
 *   - Portamento / glide control
 *   - LFO modulation routing
 *   - QWERTY keyboard and MIDI input
 */
public class MainActivity extends AppCompatActivity {
    ...
    static final String SYNTH_URL =
            ASSET_BASE_URL + "plugins/Minimoog/Minimoog.html";
