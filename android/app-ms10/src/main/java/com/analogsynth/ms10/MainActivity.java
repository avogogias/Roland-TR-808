...
/**
 * Korg MS-10 Monophonic Synthesizer — standalone Android app.
 *
 * Features verified:
 *   - Single VCO with waveform selection (sawtooth, square, triangle)
 *   - Korg transistor-ladder LPF (AudioWorklet)
 *   - Single ADSR envelope generator
 *   - LFO modulation with rate and delay
 *   - Keyboard and MIDI input
 *   - Simplified signal path vs MS-20
 */
public class MainActivity extends AppCompatActivity {
    ...
    static final String SYNTH_URL =
            ASSET_BASE_URL + "plugins/MS10/MS10.html";
